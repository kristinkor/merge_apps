...
class TipCalculator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Tip calculator by Kristina Korzhenevskaya',
      theme: ThemeData(
      ...
      home: const MyHomePage(title: 'Tip calculator by Kristina Korzhenevskaya'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _incrementCounter() {
    setState(() {
      ...
      else if (t1=='') result='Service is missing';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          children:[
            Padding(
              ...
              child: Text(result, style: TextStyle(
                fontSize: 30, fontFamily:'Black Ariel', color: Colors.orange
              ),),
            ),
            Container(width: 300,
              child: Padding(
              ...
              'G-good,A-allright,N-notbad,P-poor', border:OutlineInputBorder()),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: _incrementCounter,  //Kristina Korzhenevskaya
        tooltip: 'Increment',
...
class TipCalculate{
  ...
  String tip({bill,service}){
    ...
    else 'G-good,A-allright,N-notbad,P-poor';
    return 'The tip is ${(bill*tipRate).round()}';
  }
}  //Kristina Korzhenevskaya